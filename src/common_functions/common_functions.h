...
namespace common_functions
{
    ...
    /**************************************************************************************************
    Описание:  Функция переконструирования объекта с помощью placement new
    Аргументы: object - ссылка на объект
               ... - аргументы конструктора

    Возврат:   -
    Замечания: Шаблонные аргументы должны выводиться.
               Пример использования: Object o{ 1,2,3}; inplace_new( o, 4, 5, 6 );

               Очень удобно использовать ее в тестах, чтобы сбросить состояние объекта без специального
               метода reset или deInit
    **************************************************************************************************/
