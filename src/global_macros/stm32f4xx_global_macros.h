...
{
    /**************************************************************************************************
    Описание:   Функция преобразования пина типа GPIO_Pin_x (вида 1<<x) в GPIO_PinSource (т.е. в х)
    Аргументы:  GPIO_Pin
    Возврат:    PinSource
    Замечания:
    **************************************************************************************************/
    inline uint16_t gpioPinToPinSource( uint16_t gpioPin )
    {
        return 31 - __CLZ(gpioPin);
    }
