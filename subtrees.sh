...
git subtree pull --prefix=src/spl	http://gitblit.dep111.rtc.local/r/EmbeddedLibs/spl.git	stm32f4xx_lite	--squash
git subtree pull --prefix=pvs	http://gitblit.dep111.rtc.local/r/EmbeddedLibs/pvs.git	release	--squash
